...
def interpolate_gripper(robot, target_angle, gripper_step_size=0.005, 
    ...
    # print(f"Interpolating gripper: {current_angle:.3f} -> {target_angle:.3f} ({num_steps} steps)")
...
def move_to_pose_dynamic(robot, target_pos, target_orn, threshold=0.01, max_steps=100, **kwargs):
    """
